...
class AuthControllerTest extends TestCase
{
    ...
    public function testLoginSubmitSuccessWithRememberMe(): void
    {
        ...
        $stmtUpdateCnx = $this->createMock(\PDOStatement::class);
        $stmtUpdateCnx->method('execute')->willReturn(true);

        $stmtRemember = $this->createMock(\PDOStatement::class);
        $stmtRemember->method('execute')->willReturn(true);

        $this->pdo->method('prepare')->willReturnOnConsecutiveCalls($stmtUser, $stmtUpdateCnx, $stmtRemember);
    ...
    public function testAutoLoginWithCookieSuccess(): void
    {
        ...
        $this->pdo->method('prepare')->willReturnOnConsecutiveCalls($stmtToken, $stmtUser, $stmtUpdateCnx, $stmtUpdate);
    ...
    public function testProfilePageRendersTemplate(): void
    {
        ...
        $stmt->method('fetchColumn')->willReturn('dummy_token_123');
    ...
    public function testSavePushSubscriptionSuccess(): void
    {
        $_SESSION['user'] = [
            'id' => 42,
            'username' => 'testuser'
        ...
        $stmtCheck = $this->createMock(\PDOStatement::class);
        $stmtCheck->method('execute')->willReturn(true);
        $stmtCheck->method('fetch')->willReturn(false); // Pas de souscription existante
        ...
        $response = $this->controller->savePushSubscription($request);
